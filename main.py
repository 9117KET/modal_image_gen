...
class Model:
    ...
    @modal.enter()
    def initialize(self):
        """Initialize API_KEY after container is running"""
    ...
    @modal.web_endpoint()
    def health(self):
        """Lighweight endpoint for keeping the container warm"""
...
def keep_warm():
    health_url="https://kinlotangiri911--sd-demo-model-health.modal.run"
    generate_url="https://kinlotangiri911--sd-demo-model-generate.modal.run"
    ...
    #Then make a test request to generate endpoints with API key
